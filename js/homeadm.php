...
<html>
  ...
  <body style="background-color: #dcdcdc; color: white">
    <header class="header fixed-header">
      <nav>
        ...
        <li><a href="listacli.php">Lista de Clientes</a></li>
          ...
          <li><a href="inccprodutos.php">Cadastro Produto</a></li>
        </ul>
      </nav>
    </header>
    ...
    <div class="carousel-container">
      ...
      <a href="vmcer.php"><button class="centered-button" id="compreAquiButton" onclick="addPressedClass()">COMPRE AQUI</button></a>
    </div>
