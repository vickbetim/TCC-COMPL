...
<html>
  ...
  <body style="background-color: #dcdcdc; color: white">
    <header class="header">
      <nav>
        ...
        <ul class="navigation">
          <li><a href="listacli.php">Lista de Clientes</a></li>
    ...
    <div class="carousel-container">
        <div class="carousel-slide">
            <img src="container4.jpeg" alt="Imagem 1">
            <div class="overlay"></div>
        </div>
        <div class="carousel-slide">
            <img src="container2.jpeg" alt="Imagem 2">
            <div class="overlay"></div>
        </div>
        <div class="carousel-slide">
            <img src="container1.jpeg" alt="Imagem 3">
            <div class="overlay"></div>
        </div>
        ...
        <!-- <button class="button"><a href="vmver.php" class="no-visited-style">COMPRE JÁ</a></button> -->
  ...
  <img src="home.png" alt="Descrição da imagem" class="imagem-full-width" />
</div>-->
