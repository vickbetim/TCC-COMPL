  ...
  <body style="background-color: #dcdcdc; color: white">
    <header class="header">
      <nav>
        ...
        <ul class="navigation">
          <li><a href="incclientes.php">Cadastrar-se</a></li>
          <li><a href="vmver.php">Produtos</a></li>
        </ul>
      </nav>
    </header>
    ...
    <div class="carousel-container">
        <div class="carousel-slide">
            <img src="container4.jpg" alt="Imagem 1">
            <div class="overlay"></div>
        </div>
        <div class="carousel-slide">
            <img src="container2.jpg" alt="Imagem 2">
            <div class="overlay"></div>
        </div>
        <div class="carousel-slide">
            <img src="container1.jpg" alt="Imagem 3">
            <div class="overlay"></div>
        </div>
